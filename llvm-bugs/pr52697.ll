...
while.cond:                                       ; preds = %while.cond, %entry
  ...
  br i1 undef, label %while.cond, label %while.cond2
...
while.cond2:                                      ; preds = %while.cond2, %while.cond
  ...
  br i1 undef, label %while.cond2, label %while.cond.1
...
while.cond.1:                                     ; preds = %while.cond.1, %while.cond2
  ...
  br i1 undef, label %while.cond.1, label %while.cond2.1
...
while.cond2.1:                                    ; preds = %while.cond2.1, %while.cond.1
  ...
  br i1 undef, label %while.cond2.1, label %while.cond.2
...
while.cond.2:                                     ; preds = %while.cond.2, %while.cond2.1
  ...
  br i1 undef, label %while.cond.2, label %while.cond2.2
...
while.cond2.2:                                    ; preds = %while.cond2.2, %while.cond.2
  ...
  br i1 undef, label %while.cond2.2, label %while.cond.3
...
while.cond.3:                                     ; preds = %while.cond.3, %while.cond2.2
  ...
  br i1 undef, label %while.cond.3, label %while.cond2.3
...
while.cond2.3:                                    ; preds = %while.cond2.3, %while.cond.3
  ...
  br i1 undef, label %while.cond2.3, label %while.cond.4
...
while.cond.4:                                     ; preds = %while.cond.4, %while.cond2.3
  ...
  br i1 undef, label %while.cond.4, label %while.cond2.4
...
while.cond2.4:                                    ; preds = %while.cond2.4, %while.cond.4
  ...
  br i1 undef, label %while.cond2.4, label %while.cond.5
...
while.cond.5:                                     ; preds = %while.cond.5, %while.cond2.4
  ...
  br i1 undef, label %while.cond.5, label %while.cond2.5
...
while.cond2.5:                                    ; preds = %while.cond2.5, %while.cond.5
  ...
  br i1 undef, label %while.cond2.5, label %while.cond.6
...
while.cond.6:                                     ; preds = %while.cond.6, %while.cond2.5
  ...
  br i1 undef, label %while.cond.6, label %while.cond2.6
...
while.cond2.6:                                    ; preds = %while.cond2.6, %while.cond.6
  ...
  br i1 undef, label %while.cond2.6, label %while.cond.7
...
while.cond.7:                                     ; preds = %while.cond.7, %while.cond2.6
  ...
  br i1 undef, label %while.cond.7, label %while.cond2.7
...
while.cond2.7:                                    ; preds = %while.cond2.7, %while.cond.7
  ...
  br i1 undef, label %while.cond2.7, label %while.cond.8
...
while.cond.8:                                     ; preds = %while.cond.8, %while.cond2.7
  ...
  br i1 undef, label %while.cond.8, label %while.cond2.8
...
while.cond2.8:                                    ; preds = %while.cond2.8, %while.cond.8
  ...
  br i1 undef, label %while.cond2.8, label %while.cond.9
...
while.cond.9:                                     ; preds = %while.cond.9, %while.cond2.8
  ...
  br i1 undef, label %while.cond.9, label %while.cond2.9
...
while.cond2.9:                                    ; preds = %while.cond2.9, %while.cond.9
  ...
  br i1 undef, label %while.cond2.9, label %while.cond.10
...
while.cond.10:                                    ; preds = %while.cond.10, %while.cond2.9
  ...
  br i1 undef, label %while.cond.10, label %while.cond2.10
...
while.cond2.10:                                   ; preds = %while.cond2.10, %while.cond.10
  ...
  br i1 undef, label %while.cond2.10, label %while.cond.11
...
while.cond.11:                                    ; preds = %while.cond.11, %while.cond2.10
  ...
  br i1 undef, label %while.cond.11, label %while.cond2.11
...
while.cond2.11:                                   ; preds = %while.cond2.11, %while.cond.11
  ...
  br i1 undef, label %while.cond2.11, label %while.cond.12
...
while.cond.12:                                    ; preds = %while.cond.12, %while.cond2.11
  ...
  br i1 undef, label %while.cond.12, label %while.cond2.12
...
while.cond2.12:                                   ; preds = %while.cond2.12, %while.cond.12
  ...
  br i1 undef, label %while.cond2.12, label %while.cond.13
...
while.cond.13:                                    ; preds = %while.cond.13, %while.cond2.12
  ...
  br i1 undef, label %while.cond.13, label %while.cond2.13
...
while.cond2.13:                                   ; preds = %while.cond2.13, %while.cond.13
  ...
  br i1 undef, label %while.cond2.13, label %while.cond.14
...
while.cond.14:                                    ; preds = %while.cond.14, %while.cond2.13
  ...
  br i1 undef, label %while.cond.14, label %while.cond2.14
...
while.cond2.14:                                   ; preds = %while.cond2.14, %while.cond.14
  ...
  br i1 undef, label %while.cond2.14, label %while.cond.15
...
while.cond.15:                                    ; preds = %while.cond.15, %while.cond2.14
  ...
  br i1 undef, label %while.cond.15, label %while.cond2.15
...
while.cond2.15:                                   ; preds = %while.cond2.15, %while.cond.15
  ...
  br i1 undef, label %while.cond2.15, label %while.cond.16
